...
public class WordLadder {
	...
	private static int shortestTransformation(String start, String end, Set<String> dict) {
		return 0;
	}
	...
	public static void main(String[] args) {
		...
		dict.add("hot");
		System.out.println("the shortest transformation from " + start + " to " + end + " is " + shortestTransformation(start, end, dict));
